...
\begin{figure}[htbp]
\begin{center}
\begin{tikzpicture}[framed,background rectangle/.style={double, thick, draw=black, rounded corners, top color=blue!20}]
	% Place nodes
	\node [block, rectangle, dotted] at (.5,4) (doc) {Document};
	\node [draw, fill=red, rounded corners] at (1.25,4.75) {\tiny Methods};
	\node [draw, fill=green, rounded corners] at (-.25,4.75) {\tiny Signals};

	\node [block, circle] at (6,4) (root) {Object};
	...
	\node [block, circle] at (5.75,.5) (child0) {Child};
	\node [block, circle] at (6,.5) (child1) {Child};
	\node [block, circle] at (6.25,.5) (child2) {Child};

	\node [block, diamond] at (2.0,1.0) (table1) {Table};
	\node [block, diamond] at (2.25,1.0) (table2) {Table};
	\node [block, diamond] at (2.5,1.0) (table3) {Table};
	
	\node [block, diamond] at (2.0,7.0) (plot1) {Plot};
	\node [block, diamond] at (2.25,7.0) (plot2) {Plot};
	\node [block, diamond] at (2.5,7.0) (plot3) {Plot};


	%\draw[->, thick](doc)--(root);

	\draw[->, dashed](root)--(table3);
	\draw[->, dashed](root)--(plot3);
	...
	%\draw[->, thick](doc)--(plot1);

	\node [draw, fill=green, rounded corners] at (1.75,2.0) {\tiny Signals};
	\node [draw, fill=red, rounded corners] at (3.25,2.0) {\tiny Methods};

	\node [draw, fill=green, rounded corners] at (1.75,8.0) {\tiny Signals};
	\node [draw, fill=red, rounded corners] at (3.25,8.0) {\tiny Methods};
	
	\node [draw, fill=red, rounded corners] at (6.75,5) {\tiny Methods};
	\node [draw, fill=green, rounded corners] at (5.25,5) {\tiny Signals};
...
\lstinputlisting[language=flatbuffers, firstline=58, lastline=98, caption=Any Definition, label=listing:any]{"../interface/noodles.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=271, lastline=304, caption=Server Root Messages]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=42, lastline=99, caption=Object Messages, label=listing:obj]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=220, lastline=231, caption=Table Messages, label=listing:tbl]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=131, lastline=143, caption=Buffer Messages, label=listing:buff]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=194, lastline=216, caption=Geometry Messages, label=listing:geom]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=163, lastline=171, caption=Texture Messages, label=listing:tex]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=147, lastline=159, caption=Material Messages, label=listing:mat]{"../interface/noodles_server.fbs"}
...
\subsection{Lights}
 ...
 \lstinputlisting[language=flatbuffers, firstline=175, lastline=190, caption=Light Messages, label=listing:light]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=246, lastline=267, caption=Communication, label=listing:sig_meth_iv]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=235, lastline=242, caption=Document Messages, label=listing:doc_mess]{"../interface/noodles_server.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=31, lastline=45, caption=Client Message Root, label=listing:client_root]{"../interface/noodles_client.fbs"}

\subsection{Introduction}

The client introduces itself to the server with the following message.

\lstinputlisting[language=flatbuffers, firstline=10, lastline=13, caption=Introduction Message, label=listing:intro]{"../interface/noodles_client.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=15, lastline=25, caption=Method Invocation, label=listing:invoke]{"../interface/noodles_client.fbs"}
...
\lstinputlisting[language=flatbuffers, firstline=27, lastline=29, caption=Buffer Refresh, label=listing:buff_refresh]{"../interface/noodles_client.fbs"}
...
\lstinputlisting[language=c++, firstline=13, lastline=16]{"./snippets/object_m_defs.cpp"}
